 ...
 * reports as "loaded without registering 'dsh-prompt-vcs' via __ModuleLoader__.load".
 *
...
await build({
  ...
  banner: {
    ...
    js: 'window.__ModuleLoader__.load({ id: "dsh-prompt-vcs", factory: (require) => {'
